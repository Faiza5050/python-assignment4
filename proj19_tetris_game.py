...
print("Python Project # 19 - Tetris")
print("Welcome To The Tetris Game!")
...
class Figure:
    ...
    figures = [
        ...
        [[1, 2, 4, 5], [1, 4, 5, 8], [4, 5, 7, 8], [2, 5, 6, 9]],
    ]
...
class Tetris:
    ...
    def break_lines(self):
        ...
        if lines > 0:
            print(f"Your Score: {self.score}", end="\r")
...
while not done:
    ...
    text = font.render("Your Score: " + str(game.score), True, RED)
    text_game_over = font1.render(game.state, True, (255, 125, 0))
